...
우리는 **AI 기반 의료영상처리**를 폭넓게 연구합니다 — 딥러닝 MRI 재구성부터 고속 정량 MRI, 움직임에 강인한 diffusion MRI까지. 실제 작업은 주로 **Python**과 **PyTorch**로 모델을 만들고 학습합니다. 의료영상, 딥러닝, MRI 물리에 관심 있다면 언제든 편하게 연락 주세요.
